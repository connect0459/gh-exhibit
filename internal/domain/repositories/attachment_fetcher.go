...
// infrastructure implements it via an authenticated request (required for
// private-repository attachments). contentType is the response's
// Content-Type header, the only reliable source of the attachment's file
// extension — the user-attachments URL path does not encode one.
